      ...
      <div className="text-center space-y-6 max-w-3xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-12">
          ...
          <Link href="/decryption">
            <div className="group relative h-48 bg-gradient-to-br from-gray-600/20 to-gray-800/20 rounded-xl border border-gray-500/30 p-6 hover:border-gray-400/50 transition-all duration-300 cursor-pointer opacity-60 hover:opacity-75">
              <div className="relative z-10 h-full flex flex-col justify-between">
